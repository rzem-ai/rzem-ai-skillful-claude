...
export const useConfigStore = defineStore('config', {
    ...
    getters: {
        ...
        projects: (s) => s.snapshot?.projects ?? [],
        ...
        guidedModel: (s) => s.snapshot?.guidedModel ?? null,
        guidedEnv: (s) => s.snapshot?.guidedEnv ?? null,
        guidedMcp: (s) => s.snapshot?.guidedMcp ?? null,
        guidedMemory: (s) => s.snapshot?.guidedMemory ?? null,
